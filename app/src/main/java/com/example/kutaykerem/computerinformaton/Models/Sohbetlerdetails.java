...
public class Sohbetlerdetails {
 ...
 public  Boolean seen;
    ...
    public Sohbetlerdetails(String type, Boolean seen, String time, String mesaj, String mesajId, String from, String hedefId, String kullanıcıAdı, String profile) {
        this.type = type;
        this.seen = seen;
        this.time = time;
        this.mesaj = mesaj;
